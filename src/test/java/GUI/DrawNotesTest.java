...
public class DrawNotesTest {
	...
	public void testDrawNotes() {
		...
		DrawNotes drawGuitarNote = new DrawNotes(pane, 40.0, 50.0, guitarNote, "guitar", 15, 0); // Initialized dummy guitar note
		DrawNotes drawDrumSetNote = new DrawNotes(pane, 60.0, 70.0, drumNote, "drumset", 15, 0); // Initialized dummy drum note
